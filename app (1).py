...
# Render the company logo and the updated portal title side-by-side in one row
# Adjusted the column layout proportions to [0.6, 4.4] to provide max width for the single-line layout
...
with col_title:
    # Using an inline CSS style layout to explicitly keep the complete heading text on a single line
...
with col2:
    ...
    with c_code_col:
        all_country_codes = [
            ...
            "+224 (Guinea)", "+245 (Guinea-Bissau)", "+592 (Report)", "+509 (Haiti)", "+504 (Honduras)", 
...
# AUTOMATICALLY EMBEDDED WEBHOOK URL
