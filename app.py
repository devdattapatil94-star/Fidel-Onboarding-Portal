...
if st.button("Submit Profile Record", type="primary"):
    ...
    # Selection field checking
    v_services = len(selected_services) > 0
    
    # File upload validation checking
    ...
    if (v_first_name and v_last_name and v_email_id and v_contact and v_city and 
        ...
        submission_summary = {
            ...
            "Bank Details": f"{b_name} | Holder: {b_holder} | Code: {b_code} | Acc: {b_acc} | Address: {b_address} | IFSC: {b_ifsc} | Swift: {b_swift}",
