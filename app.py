...
if st.button("Submit Profile Record", type="primary"):
    ...
    if has_first_name and has_email and has_native_lang:
        ...
        submission_summary = {
            ...
            "Bank Details": f"{b_name} | Holder: {b_holder} | Code: {b_code} | Acc: {b_acc} | Address: {b_address} | IFSC: {b_ifsc}",
