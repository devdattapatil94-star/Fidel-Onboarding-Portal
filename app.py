...
# Set up the tab title and the browser tab icon to use the official Fidel logo
st.set_page_config(
    page_title="Fidel Softech Resource Onboarding", 
    page_icon="https://www.fideltech.com/wp-content/themes/Divi/images/logo.png", 
    layout="centered"
)
...
with col_logo:
    st.image("https://www.fideltech.com/wp-content/themes/Divi/images/logo.png", width=140)
with col_title:
