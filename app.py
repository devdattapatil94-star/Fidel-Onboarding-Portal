...
# ==========================================
# 2. CUSTOM BACKGROUND & WATERMARK CONFIGURATION (FORCE LIGHT THEME)
# ==========================================
...
if os.path.exists(bg_logo_path):
    ...
    custom_style = f'''
    <style>
    /* 1. FORCE CORE CONTAINERS TO SOLID WHITE */
    .stApp, [data-testid="stHeader"], [data-testid="stSidebar"], [data-testid="stAppViewContainer"] {{
        background-color: #FFFFFF !important;
    }}
    
    /* 2. FORCE DIALOGUE/INPUT BOXES TO LIGHT GRAY/WHITE INSTEAD OF BLACK */
    div[data-baseweb="input"], div[data-baseweb="select"], .stTextArea textarea, .stTextInput input, div[data-testid="stMarkdownContainer"] {{
        background-color: #F8FAFC !important;
        color: #1E293B !important;
        border: 1px solid #CBD5E1 !important;
    }}
    
    /* 3. INJECT THE CENTERED WATERMARK LOGO */
    .stApp::before {{
        content: ""; 
        position: fixed; 
        top: 0; 
        ...
        background-size: 35%;
        opacity: 0.08;        /* Set to 8% for perfect balance on the white canvas */
        pointer-events: none;
    }}
    
    /* 4. FORCE ALL TEXT TO DARK READABLE SLATE */
